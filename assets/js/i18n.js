...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function updatePageLanguage(lang) {
    ...
    // Update capabilities preview items
    const capabilityItemsEn = document.querySelectorAll('.capability-item.capability-en');
    const capabilityItemsZh = document.querySelectorAll('.capability-item.capability-zh');
    
    capabilityItemsEn.forEach(item => {
      item.classList.toggle('hidden', lang === 'zh');
    });
    
    capabilityItemsZh.forEach(item => {
      item.classList.toggle('hidden', lang === 'en');
    })
